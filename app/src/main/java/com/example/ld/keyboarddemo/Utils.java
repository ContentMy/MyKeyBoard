...
public class Utils {
    ...
    private Utils(Activity activity, EditText edit) {
        this.ed = edit;
        k1 = new Keyboard(activity, R.xml.test_letter);
        k2 = new Keyboard(activity, R.xml.test_number);
        k3 = new Keyboard(activity, R.xml.test_symbol);
    ...
    public static Utils shared(Activity activity, EditText edit) {
        if (mInstance == null) {
            mInstance = new Utils(activity, edit);
        }
        mInstance.ed = edit;
        return mInstance;
    }
